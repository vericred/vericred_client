...
# Unit tests for VericredClient::ZipCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZipCode' do
  before do
    # run before each test
    @instance = VericredClient::ZipCode.new
  end
  ...
  describe 'test an instance of ZipCode' do
    it 'should create an instact of ZipCode' do
      @instance.should be_a(VericredClient::ZipCode) 
    end
  end
