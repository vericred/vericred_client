...
# Unit tests for VericredClient::RatingArea
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RatingArea' do
  before do
    # run before each test
    @instance = VericredClient::RatingArea.new
  end
  ...
  describe 'test an instance of RatingArea' do
    it 'should create an instact of RatingArea' do
      @instance.should be_a(VericredClient::RatingArea) 
    end
  end
