...
# Unit tests for VericredClient::Carrier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Carrier' do
  before do
    # run before each test
    @instance = VericredClient::Carrier.new
  end
  ...
  describe 'test an instance of Carrier' do
    it 'should create an instact of Carrier' do
      @instance.should be_a(VericredClient::Carrier) 
    end
  end
