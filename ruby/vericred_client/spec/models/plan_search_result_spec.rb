...
# Unit tests for VericredClient::PlanSearchResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanSearchResult' do
  before do
    # run before each test
    @instance = VericredClient::PlanSearchResult.new
  end
  ...
  describe 'test an instance of PlanSearchResult' do
    it 'should create an instact of PlanSearchResult' do
      @instance.should be_a(VericredClient::PlanSearchResult) 
    end
  end
  ...
  describe 'test attribute "match_percentage"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "perfect_match_percentage"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
