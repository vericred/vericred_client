...
# Unit tests for VericredClient::Applicant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Applicant' do
  before do
    # run before each test
    @instance = VericredClient::Applicant.new
  end
  ...
  describe 'test an instance of Applicant' do
    it 'should create an instact of Applicant' do
      @instance.should be_a(VericredClient::Applicant) 
    end
  end
