...
# Unit tests for VericredClient::InlineResponse2002
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2002' do
  before do
    # run before each test
    @instance = VericredClient::InlineResponse2002.new
  end
  ...
  describe 'test an instance of InlineResponse2002' do
    it 'should create an instact of InlineResponse2002' do
      @instance.should be_a(VericredClient::InlineResponse2002) 
    end
  end
  describe 'test attribute "zip_counties"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
